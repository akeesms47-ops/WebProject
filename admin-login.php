...
<head>
    ...
    <title>Admin Login - SOLID CAMPUS</title>
...
<body>
    ...
    <div class="login-card">
        ...
        <div id="error-msg" class="alert-error">Invalid Username or Password</div>
        ...
        <form id="loginForm">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" placeholder="e.g. admin123" required>
            </div>
